    ...
    '<h2>Lease Mileage Calculator</h2>',
      '<form action="" id="lc-form" class="lc-form">',
        '<div id="lc-start-date-ctr" class="lc-input-ctnr">',
          ...
          '<input type="date" name="lc-start-date" id="lc-start-date" value="08/16/2021" placeholder="03/17/2018">',
        '</div>',
        ...
        '<div id="lc-mileage-before-lease-ctr" class="lc-input-ctnr lc-input-ctnr--last">',
          ...
          '<input type="text" name="lc-mileage-before-lease" id="lc-mileage-before-lease" value="12" placeholder="400">',
        '</div>',
